...
else 
{
    ...
    try 
    {
        if (isset($_POST['submit'])) 
        {
            ...
            $checkSql = "SELECT ID FROM tblplanner WHERE Class = :classId";
            ...
            else
            {
                ...
                if ($_FILES['plannerPdf']['error'] === UPLOAD_ERR_OK) 
                {
                    $fileTmpPath = $_FILES['plannerPdf']['tmp_name'];
                    $fileName = $_FILES['plannerPdf']['name'];
                    $fileSize = $_FILES['plannerPdf']['size'];
                    $fileType = $_FILES['plannerPdf']['type'];
                    ...
                    if (in_array($fileExtension, $allowedExtensions) && $fileSize <= $maxFileSize) 
                    {
                        ...
                        {
                            $sql = "INSERT INTO tblplanner (Class, Planners) VALUES (:classId, :plannerFile)";
                            $query = $dbh->prepare($sql);
                            $query->bindParam(':classId', $classId, PDO::PARAM_INT);
                            $query->bindParam(':plannerFile', $newFileName, PDO::PARAM_STR);
                            $query->execute();
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="plannerPdf" class="form-control-file" accept=".pdf" required>
