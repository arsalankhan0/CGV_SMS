                                        ...
                                        <div class="table-responsive border rounded p-1">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $retTotal = "SELECT COUNT(*) 
                                                                FROM tblnotes notes
                                                                JOIN tblemployees emp ON FIND_IN_SET(notes.Class, emp.AssignedClasses) 
                                                                AND FIND_IN_SET(notes.Subject, emp.AssignedSubjects)
                                                                WHERE emp.ID = :empID 
                                                                AND emp.IsDeleted = 0";
                                                    ...
                                                    $ret = "SELECT notes.ID, notes.Class, notes.Title, notes.Subject, notes.Notes 
                                                            FROM tblnotes notes
                                                            JOIN tblemployees emp ON FIND_IN_SET(notes.Class, emp.AssignedClasses) 
                                                            AND FIND_IN_SET(notes.Subject, emp.AssignedSubjects)
                                                            WHERE emp.ID = :empID 
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo "../admin/notes/".htmlentities($row->Notes); ?>" target="_blank">View Notes</a></td>
                                                                <td>
                                                                    <div>
                                                    ...
                                                    {
                                                        echo "<tr><th colspan='6' class='text-center'>No Notes Available</th></tr>";
                                                    }
                                                    ?>
                                                </tbody>
                                            </table>
