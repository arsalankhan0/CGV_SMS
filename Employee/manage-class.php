...
else
{
  ...
  $requiredPermission = $requiredPermissions['manage-class']; 
                      ...
                      <table class="table">
                        ...
                        <thead>
                          <tr>
                            ...
                            if ($employeePermissions['Class']['UpdatePermission'] == 1 || $employeePermissions['Class']['DeletePermission'] == 1) 
                            { ?>
                                      ...
                                      <td>
                                        <div>
                                          <?php 
                                            ...
                                            if ($employeePermissions['Class']['UpdatePermission'] == 1) { ?>
                                            ...
                                            if ($employeePermissions['Class']['DeletePermission'] == 1) { ?>
