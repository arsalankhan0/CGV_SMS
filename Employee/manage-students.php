                                                ...
                                                if ($studentQuery->rowCount() > 0) {
                                                    ...
                                                    foreach ($students as $student) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <?php if (isset($employeePermissions['Students']) && ($employeePermissions['Students']['UpdatePermission'] == 1)) { ?>
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if (isset($employeePermissions['Students']) && ($employeePermissions['Students']['UpdatePermission'] == 1 && $employeePermissions['Students']['DeletePermission'] == 1)) { ?>
                                                                        ||
                                                                    <?php } ?>
                                                                    <?php if (isset($employeePermissions['Students']) && ($employeePermissions['Students']['DeletePermission'] == 1)) { ?>
