<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-basic-role" aria-expanded="false"
        aria-controls="ui-basic-role">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-basic-permission" aria-expanded="false"
        aria-controls="ui-basic-permission">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-basic-section" aria-expanded="false"
        aria-controls="ui-basic-section">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-basic-exam" aria-expanded="false"
        aria-controls="ui-basic-exam">
      ...
      <div class="collapse" id="ui-basic-exam">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="download-report-cards.php">Download Final Report Cards</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-basic-report" aria-expanded="false"
        aria-controls="ui-basic-report">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-curricular" aria-expanded="false"
        aria-controls="ui-curricular">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#ui-employees" aria-expanded="false"
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#latestUpdate" aria-expanded="false" aria-controls="latestUpdate">
        <span class="menu-title">Latest Updates</span>
        <i class="icon-doc menu-icon"></i>
      </a>
      <div class="collapse" id="latestUpdate">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="add-updates.php">Add Updates</a></li>
          <li class="nav-item"> <a class="nav-link" href="manage-updates.php"> Manage Updates </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
