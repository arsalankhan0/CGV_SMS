...
else
{
  ...
  try
  {
    if(isset($_POST['confirmDelete']))
    {
      ...
      $successAlert = true;
      echo "<script>window.location.href = 'between-dates-reports.php'</script>";     
    }
  }
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div>
                                <a href="edit-student-detail.php?editid=<?php echo htmlentities ($row->sid);?>"><i class="icon-pencil"></i></a>
                                                ||
