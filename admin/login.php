            ...
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-0" id="login" method="post" name="login">
                ...
                <div class="d-flex justify-content-end mb-3">
                  <div>
                    <input type="radio" id="admin" name="role" value="admin" <?php if (!isset($_COOKIE["role"]) || $_COOKIE["role"] == "admin") { ?> checked <?php } ?> /><label for="admin" class="px-1">Admin</label>
                    <input type="radio" id="emp" name="role" value="employee" <?php if (isset($_COOKIE["role"]) && $_COOKIE["role"] == "employee") { ?> checked <?php } ?> /><label for="emp"
                      class="px-1">Employee</label>
                  </div>
                </div>
