...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
        ...
        try {
            ...
            if (isset($_POST['assignPermissions'])) {
                ...
                foreach ($_POST['permissions'] as $permissionName => $permissionValues) {
                    ...
                    $create = $permissionValues['create'];
                    $update = $permissionValues['update'];
                    $delete = $permissionValues['delete'];
    ...
    <body>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="post">
                                            ...
                                            <button type="button" class="btn btn-primary mr-2" id="fetchPermissions">Assign
                                                Permissions</button>
                                        </form>
        ...
        <script>
            ...
            function updatePermissionValue(checkbox) {
                const hiddenInputId = checkbox.id.replace('checkbox_', 'permissions_');
