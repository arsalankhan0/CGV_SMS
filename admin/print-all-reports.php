                            ...
                            <div class="card-body" id="report-card">
                                ...
                                <div class="mt-4 ">
                                    <div class="d-flex flex-row justify-content-between font-weight-bold">
                                        <div>
                                            <label>Student's Code No:</label><span class="dark-line ml-2 px-3"><?php echo htmlentities($studentDetails['CodeNumber']); ?></span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex w-100 align-items-center font-weight-bold">
                                        ...
                                        <p class="border-bottom border-dark ml-2 pl-3 w-100 text-capitalize" style="box-sizing: border-box;"><span><?php echo htmlentities($studentDetails['StudentName']); ?></span></p>
                                    </div>
                                    <!-- Parent's Name -->
                                    <div class="d-flex w-100 align-items-center font-weight-bold">
                                        <label class="text-nowrap">Parents'/Guardian's Name: </label>
                                        <p class="border-bottom border-dark ml-2 pl-3 w-100 text-capitalize" style="box-sizing: border-box;"><span><?php echo htmlentities($studentDetails['FatherName']); ?></span></p>
                                    </div>
                                </div>
                                <!-- Main Subjects -->
                                ...
                                <footer class="d-flex flex-column  mt-3">
                                    ...
                                    <div class="d-flex justify-content-between mt-5">
                                        <div>
                                            <label class="font-weight-bold">Date:</label><span class="dark-line ml-2 signature-line"></span>
                                        </div>
                                        <div>
                                            <label class="font-weight-bold">Signature of Tr. Incharge:</label><span class="dark-line ml-2 signature-line"></span>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between mt-5">
                                        <div>
                                            <label class="font-weight-bold">Promoted to Class:</label><span class="dark-line ml-2 signature-line"></span>
                                        </div>
                                        <div>
                                            <label class="font-weight-bold">Supervisor/Principal:</label><span class="dark-line ml-2 signature-line"></span>
                                        </div>
                                    </div>
                                </footer>
                            </div>
