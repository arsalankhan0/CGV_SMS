                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                            <?php  
                              echo htmlentities($row->ClassName) ." ". htmlentities($row->Section);
                              ?>
                            </td>
