...
else 
{
    ...
    try
    {
        if(isset($_POST['confirmDelete']))
        {
            ...
            $query->execute();
            $successAlert = true;
            $msg = "Assignment of the selected class deleted successfully.";
        }
    }
    catch (PDOException $e) 
    {
        $dangerAlert = true;
        $msg = "Ops! An error occurred while deleting the Assignment!";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo "syllabus/".htmlentities($row->Syllabus); ?>" target="_blank">View Assignment</a></td>
                                                                <td>
                                                                    <div>
