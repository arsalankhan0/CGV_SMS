            ...
            <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-sm-0">Manage Roles</h4>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $ret = "SELECT ID FROM tblroles";
                                $query1 = $dbh -> prepare($ret);
                                $query1->execute();
                                $results1=$query1->fetchAll(PDO::FETCH_OBJ);
                                $total_rows=$query1->rowCount();
                                $total_pages = ceil($total_rows / $no_of_records_per_page);
                                $sql="SELECT * from tblroles WHERE IsDeleted = 0 LIMIT $offset, $no_of_records_per_page";
                                $query = $dbh -> prepare($sql);
                                $query->execute();
                                ...
                                if($query->rowCount() > 0)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <div><a href="edit-role.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="icon-pencil"></i></a>
