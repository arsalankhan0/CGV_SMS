            ...
            if (!empty($_FILES['notes']['name'])) 
            {
                ...
                if (in_array($fileExtension, $allowedExtensions) && $notesSize <= $maxFileSize) {
                    ...
                    if (move_uploaded_file($notesTmpName, $destPath)) 
                    {
                        ...
                        $sql = "UPDATE tblnotes SET notes=:notes WHERE ID=:eid";
                        $query = $dbh->prepare($sql);
                        $query->bindParam(':notes', $fileName, PDO::PARAM_STR);
                        $query->bindParam(':eid', $eid, PDO::PARAM_INT);
                        $query->execute();
                        $successAlert = true;
                        $msg = "Notes of the selected class has been updated successfully.";
                    } 
                    else 
                    {
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-align: center;">Update notes of Class <?php echo htmlspecialchars($className); ?></h4>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Are you sure you want to update notes of Class <?php echo htmlspecialchars($className); ?>?
                                                    </div>
